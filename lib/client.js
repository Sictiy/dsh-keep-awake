 ...
 * polls the host's authenticated /api/dsh-keep-awake/state route every 3 seconds.
 *
  ...
  factory: (require) => {
    ...
    const MESSAGES = {
      ...
      en: {
        ...
        'rows.probe': 'Activity probe',
        'probe.healthy': 'healthy',
        'probe.degraded': 'degraded (fail-closed awake)',
        ...
        return h(
          ...
          h(
            ...
            h(
              'div',
              { style: styles.row },
              h('span', { style: { ...styles.label, ...styles.dim } }, t('rows.probe')),
              h(
                'span',
                null,
                state !== null ? (state.probeHealthy ? t('probe.healthy') : t('probe.degraded')) : '—',
              ),
            ),
            h(
              'div',
          ...
          state !== null && state.helperError !== null && state.helperError !== ''
            ...
            : null,
          state !== null && !state.probeHealthy && state.probeError
            ? h('div', { style: styles.error }, 'Activity probe: ' + state.probeError)
            : null,
